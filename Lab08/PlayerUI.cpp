...
bool PlayerUI::IsPlayerInFirst() const
{
    ...
    int eLap = e->GetComponent<VehicleMove>()->GetCurrentLap();
    int pLap = p->GetComponent<VehicleMove>()->GetCurrentLap();
    int eCheck = e->GetComponent<VehicleMove>()->GetLastCheck();
    int pCheck = p->GetComponent<VehicleMove>()->GetLastCheck();
    float eDist = e->GetComponent<VehicleMove>()->DistanceToNextCheckpoint();
    float pDist = p->GetComponent<VehicleMove>()->DistanceToNextCheckpoint();
